...
# 自定义包
from util_parse_igs.file_load import file_load
from util_parse_igs.get01_size import get01_size
from util_parse_igs.get02_surface import get02_surface
from util_parse_igs.get03_volume import get03_volume
from util_parse_igs.get04_structural import get04_structural
from util_parse_igs.get05_thickness import get05_thickness


class util_parse_igs:
    def __init__(self):
        # 内置变量
